    ...
    <div
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        ...
        <el-form-item prop="password">
          <el-input size="medium" style="margin: 5px 0" prefix-icon="el-icon-lock" v-model="user.password"
                    placeholder="请输入密码" show-password></el-input>
        </el-form-item>

        <el-form-item prop="confirmPassword">
          <el-input size="medium" style="margin: 5px 0" prefix-icon="el-icon-lock" v-model="user.confirmPassword"
...
import { registerRequest } from "api/modules";
export default {
  name: "Register",
  data() {
    return {
    ...
    login() {
      ...
      this.$refs['userForm'].validate((valid) => {
        if (valid) {
          ...
          registerRequest(this.user).then((res) => {
